...
def measure_distance(segmented_image, segmented_arm_image, arm_spread_image, waist_image, image, metre_pixel_x,
    ...
    cv2.imwrite('detected_wrist.jpg',
                np.concatenate((arm_spread_image, cv2.cvtColor(segmented_arm_image, cv2.COLOR_GRAY2RGB)), axis=1))
    print
    ...
    print
    "Shoulder Length", dist
    print
    "Sleeve Length", dist_sleeve, (dist4, dist5)
...
def main():
    ...
    image2 = cv2.rectangle(image2, (coordinate[0][0], coordinate[0][1]), (coordinate[1][0], coordinate[1][1]),
                           (255, 0, 0), 3)
    ...
    measure_distance(segmented_image, segmented_arm_image, arm_spread_image, waist_image, image22, metre_pixel_x,
                     metre_pixel_y)
